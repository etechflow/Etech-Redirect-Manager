 ...
 * creates the checkout session using ITS OWN payment keys (managed in the portal
 * admin -> Settings) and returns the checkout URL. No payment keys live in Magento.
 */
class Checkout extends Action
{
    ...
    public function execute(): ResultInterface
    {
        ...
        $gate = $this->resultFactory->create(ResultFactory::TYPE_REDIRECT)->setPath('redirectmanager/license/gate');
        ...
        $payload = json_encode([
            ...
            'magento_callback' => $this->getUrl('redirectmanager/license/activated'),
            'magento_cancel'   => $this->getUrl('redirectmanager/license/gate'),
        ]);
