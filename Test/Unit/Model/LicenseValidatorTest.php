...
namespace Etechflow\RedirectManager\Test\Unit\Model;
...
class LicenseValidatorTest extends TestCase
{
    ...
    private const REVOKED    = 'etechflow_redirectmanager/license/revoked';
    private const GRACE_PREFIX = 'etf_rm_lic_grace_';
    ...
    public function testForgedKeyAndAttackerControlledConfigCannotBypass(): void
    {
        ...
        $this->setConfig([
            ...
            'etechflow_redirectmanager/license/issued_key'    => 'SP-i-made-this-up',
            'etechflow_redirectmanager/license/issued_at'     => (string) time(),
            'etechflow_redirectmanager/license/ip_blocked'    => '0',
        ]);
    ...
    public function testGraceFromPriorSuccessKeepsStorefrontLiveWhilePortalUnreachable(): void
    {
        ...
        $graceKey = self::GRACE_PREFIX . md5($host . ':' . $key);
    ...
    public function testGraceDoesNotApplyToADifferentHost(): void
    {
        ...
        $goodGraceKey = self::GRACE_PREFIX . md5('shop.example.com:SP-live-abc123');
        $this->cache->method('load')->willReturnCallback(
